...
UserChecker::checkRoles(['admin'] ,$r->url('login'));
    ...
    $title = "Administration | Administrateurs";
    $nav = "admin.users";
    $pdo = App::getPDO();
    ...
    $tableQuery
        ->sortable('id', 'username', 'email', 'role');
...
<div class="container">
    ...
    <h5 class="display-6 mb-3">Gestion des administrateurs</h5>

    <?php if(empty($users)): ?>
        <div class="text-center mt-4">
            <h2>Aucun <span class="text-primary">administrateur</span> :(</h2>
            <p class="lead">
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th><?= FilterHelper::sort('role', 'Role', $_GET) ?></th>
